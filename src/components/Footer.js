import { Container, Grid, IconButton, SvgIcon, Typography } from '@mui/material';
    ...
    <section className={classes.container}>
      <Container maxWidth="lg">
        <Grid container justifyContent="center" alignItems="center">
          ...
          >
            ...
            <Grid item>
              <IconButton
                component="a"
                target="_blank"
                href="https://www.aparat.com/rastaiha"
              >
                <SvgIcon sx={{ color: "#C3C3C3" }}>
          ...
          <Grid item>
            <Typography align="center" sx={{ color: "#C3C3C3" }}>
              تمامی حقوق برای جمع علمی-ترویجی رستا محفوظ است.
            </Typography>
          </Grid>
        </Grid>
      </Container>
